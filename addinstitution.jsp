...
<body class="ContentBody" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/addinstitution.jsp">
<form name="institutionForm" method="post" action="addmoney.do" onSubmit="return institutionValidate()" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/addinstitution.jsp">
<div class="MainDiv">
