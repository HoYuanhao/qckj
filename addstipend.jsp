...
<body class="ContentBody" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/addstipend.jsp">
<form name="stipendForm" method="post" action="modifystipend.do?action=addstipend" onSubmit="return stipendValidate();"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/addstipend.jsp">
<div class="MainDiv">
