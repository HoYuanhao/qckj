...
<body class="ContentBody" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/detaileducate.jsp">
<form name="educateForm" method="post" action="modifyeducate.do?action=addeducate" onsubmit="return educateValidate();" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/detaileducate.jsp">
<div class="MainDiv">
