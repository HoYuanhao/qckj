...
<body class="ContentBody" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-26" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/updateeducate.jsp">
<form name="educateForm" method="post" action="modifyeducate.do?action=updateeducate" onSubmit="return educateValidate();" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-26" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/updateeducate.jsp">
<div class="MainDiv">
