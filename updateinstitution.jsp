...
<body class="ContentBody" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/updateinstitution.jsp">
 <form name="institutionForm" method="post" action="modifyinstitution.do?action=updateinstitution" onSubmit="return institutionValidate()" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/updateinstitution.jsp">
<div class="MainDiv">
