...
<body class="ContentBody" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/updatestipend.jsp">
<form name="stipendForm" method="post" action="modifystipend.do?action=updatestipend" onSubmit="return stipendValidate();"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/qckj Maven Webapp/src/main/webapp/updatestipend.jsp">
<div class="MainDiv">
